...
const CreatePostForm = (params) => {
     ...
     const handleImageUpload = (e) => {
          ...
          axios.post("https://localhost:7047/upload", formData)
               .then((response) => {
     ...
     return(
          ...
          <div className="flex flex-col items-center bg-blue-100 h-64 w-96 shadow-lg rounded-xl">
               ...
               <form onSubmit={handlePostSubmit} className="flex flex-col items-center w-full pl-2 pr-2">
                    ...
                    <input type="text" name="title" className="text-center" placeholder="Amazing hiking trail" />
                    <label htmlFor="location">Location:</label>
                    <input type="text" name="location" placeholder="San Antonio, TX" className="text-center" />
                    <label htmlFor="tags">Tags:</label>                         <input type="text" name="tags" placeholder="Tags: separate tags with a semicolon (;)" className="w-full text-center" />
